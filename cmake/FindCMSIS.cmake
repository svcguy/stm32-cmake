...
FOREACH(SRC ${CMSIS_DEVICE_SOURCES})
    ...
    FIND_FILE(CMSIS_${SRC_CLEAN}_FILE ${SRC}
        ...
        HINTS ${STM32Cube_DIR}/Drivers/CMSIS/Device/ST/STM32${STM32_FAMILY}xx/Source/Templates/ ${PROJECT_SOURCE_DIR}
        CMAKE_FIND_ROOT_PATH_BOTH
    )
...
IF(STM32_CHIP_TYPE)
    ...
    FIND_FILE(CMSIS_STARTUP_SOURCE_FILE ${CMSIS_STARTUP_SOURCE}
        PATH_SUFFIXES src stm32${STM32_FAMILY_LOWER} cmsis
        HINTS ${STM32Cube_DIR}/Drivers/CMSIS/Device/ST/STM32${STM32_FAMILY}xx/Source/Templates/gcc/ ${PROJECT_SOURCE_DIR} ${CMAKE_CURRENT_SOURCE_DIR}
        CMAKE_FIND_ROOT_PATH_BOTH
    )
    LIST(APPEND CMSIS_SOURCES ${CMSIS_STARTUP_SOURCE_FILE})
ENDIF()

MESSAGE(STATUS "CMSIS_SOURCES: ${CMSIS_SOURCES}")
